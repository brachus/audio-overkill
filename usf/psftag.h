...
extern "C" {
    ...
    // Set a tag variable.
    //
    void usftag_setvar(void *psftag, const char *variable,
		       const char *value);
    ...
    // Otherwise, returns -1 and sets the output to an empty terminated string
    //
    int usftag_raw_getvar(const char *tag, const char *variable,
    ...
    //
    void usftag_raw_setvar(char *tag, int tag_max_size,
